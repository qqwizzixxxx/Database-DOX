...
from pystyle import Colorate, Colors, Center # type: ignore
from pystyle import * # type: ignore
...
if __name__ == "__main__":
    Database_Dox_Title = "DataBase"
    set_title(Database_Dox_Title)
...
'                                Github: github.com/qqwizzixxxx/Database-DOX                                           \n'
)
...
while True:    
    ...
    if __name__ == "__main__":
        Database_Dox_Tool = "Github qqwizzixxxx"
        se2t_title(Database_Dox_Title)
...
░▒████▓  ▓█   ▓██▒ ▒██▒ ░  ▓█   ▓██▒░▓█  ▀█▓ ▓█   ▓██▒▒██████▒▒░▒████▒
 ...
 ░                                        ░                                   
        ...
        from geninn import generate_inn # type: ignore
        input("Нажмите Enter, чтобы продолжить...")

    elif select == '21':
        from ukphone import generate_phone # type: ignore
        input("Нажмите Enter, чтобы продолжить...") 
...
░▒████▓  ▓█   ▓██▒ ▒██▒ ░  ▓█   ▓██▒░▓█  ▀█▓ ▓█   ▓██▒▒██████▒▒░▒████▒
 ...
 ░                                        ░                              
        ...
        found_in_ynula = Database(pas, search_value)
        input("Нажмите Enter, чтобы продолжить...")            

    elif select == '20':
        from rusphone import generate_phone_number # type: ignore
        input("Нажмите Enter, чтобы продолжить...")                     
...
░▒████▓  ▓█   ▓██▒ ▒██▒ ░  ▓█   ▓██▒░▓█  ▀█▓ ▓█   ▓██▒▒██████▒▒░▒████▒
 ...
 ░                                        ░                                   
        ...
        import anonim # type: ignore
        input("Нажмите Enter, чтобы продолжить...") 

    elif select == '16':
        from genmail import generate_email # type: ignore
        input("Нажмите Enter, чтобы продолжить...")

    elif select == '17':
        from genpasswd import generate_password # type: ignore
        input("Нажмите Enter, чтобы продолжить...")   

    elif select == '18':
        from gensnils import generate_snils # type: ignore
        input("Нажмите Enter, чтобы продолжить...")              

    elif select == '26':
        import dox # type: ignore
        input("Нажмите Enter, чтобы продолжить...")

    elif select == '27':   
        import osint # type: ignore
        input("Нажмите Enter, чтобы продолжить...") 

    elif select == '14':
        import mullvad # type: ignore
        input("Нажмите Enter, чтобы продолжить...")    

    elif select == '13': 
        import passports # type: ignore 
        input("Нажмите Enter, чтобы продолжить...")
        ...
        import swat # type: ignore 
        input("Нажмите Enter, чтобы продолжить...")             
                
    elif select == '15':
        import gencards # type: ignore
        input("Нажмите enter для продолжения")
        

    elif select == '28':
        import deanon # type: ignore
        input("Нажмите enter для продолжения")

    elif select == '30':
        import snonvk # type: ignore
        input("Нажмите enter для продолжения")  

    elif select == '29':
        import snostg # type: ignore
        input("Нажмите enter для продолжения")      
...
░▒████▓  ▓█   ▓██▒ ▒██▒ ░  ▓█   ▓██▒░▓█  ▀█▓ ▓█   ▓██▒▒██████▒▒░▒████▒
 ...
 ░                                        ░                                   
        ...
        Developers: qqwizzixxxx, SkidoLOL, R0YAL|GXZ, @ImInfoFinder, @ArbuzerProtected  
        ''')   
        input("Нажмите Enter, чтобы продолжить...") 

    elif select == '22':
        from genmac import generate_mac # type: ignore
        input("Нажмите Enter, чтобы продолжить...")    

    elif select == '35':
        import bomb # type: ignore
        input("Нажмите Enter, чтобы продолжить...")  

    elif select == '36':
        print("А Вот Нету Дудоса :(")
        input("Нажмите Enter, чтобы продолжить...")

    elif select == '24':
        from genip import generate_ip # type: ignore 
        input("Нажмите Enter, чтобы продолжить...") 

    elif select == '23':
        from genfake import generate_fake_person # type: ignore 
        input("Нажмите Enter, чтобы продолжить...")        
